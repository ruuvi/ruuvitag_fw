...
#define APPLICATION_DEVICE_NAME         "Ruuvi-nobme"                         /**< BLE name displayed in scan response. */
...
#define INIT_FWREV                      "2.5.4"                         /**< Github tag. Do not include specifiers such as "alpha" so you can accept ready binaries as they are **/
