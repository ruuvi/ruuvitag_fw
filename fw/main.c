...
#define DEVICE_NAME                     "RuuviTag_Firmware"                           /**< Name of device. Will be included in the advertising data. */
...
{
    pstorage_sys_event_handler(sys_evt); // This line is added to support Device Manager
...
{
    uint32_t err_code;
    bool erase_bonds = 0; // Set to 1 to erase all bonds
