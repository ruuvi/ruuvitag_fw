...
/* UART */
#define UART0_ENABLED 1 // Not needed, but example requires to compile

#if (UART0_ENABLED == 1)
#define UART0_CONFIG_HWFC         NRF_UART_HWFC_DISABLED
#define UART0_CONFIG_PARITY       NRF_UART_PARITY_EXCLUDED
#define UART0_CONFIG_BAUDRATE     NRF_UART_BAUDRATE_38400
#define UART0_CONFIG_PSEL_TXD 4 // was 6
#define UART0_CONFIG_PSEL_RXD 5 // was 8
#define UART0_CONFIG_PSEL_CTS 6 // was 7
#define UART0_CONFIG_PSEL_RTS 7 // was 5
